...
```{r}
tendencies_education_completion_rates <- ggplot(merged_data, aes(x = Year, y = education_completion_rate.x, color = `Country`, group = Country)) +
    geom_line(size = 0.8) +
    geom_point() +
    labs(
      title = glue("Education completion rate"),
      # subtitle = "",
      x = "Year",
      y = "Completion rate (%)",
      color = "Country"
